...
% source preproc_config.sh; /opt/matlab/R2014b/bin/mcc -m C_preproc_detrend_filter_excecute -a ${ToolboxPath}/NIfTI_20140122 -a ${ToolboxPath}/spm_detrend -a ${ScriptsPath}/C_matlab_steps
